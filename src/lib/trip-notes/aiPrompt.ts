...
/**
 * 締切の 2 項目を「書類に書かれていなくても調べて埋めてよい」とする例外規定の本文。
 *
 * ■ なぜ定数に切り出してあるのか
 ...
 */
export const DEADLINE_FILL_RULE = `   例外にする理由は、この 2 つが他の項目と性質が違うからです。到着時刻や確認番号は
 ...
 * 切り出してある理由と、先頭の 1 行が入っていない理由は DEADLINE_FILL_RULE と同じ。
 */
